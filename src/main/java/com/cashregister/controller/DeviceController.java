...
public class DeviceController {
	...
	public ResponseEntity<?> addNewDevice(@RequestBody DeviceDTO deviceDTO, @PathVariable("siteId") Integer siteId,
		...
		return new ResponseEntity<DevicePlusDeviceModelDTO>(
				deviceService.addNewDevice(deviceDTO, siteId, deviceModelId), HttpStatus.OK);
	}

	@RequestMapping(value = "/device", method = RequestMethod.GET)
	public ResponseEntity<?> getDevicesBySiteId(@RequestParam("siteId") int siteId) throws Exception {
		return new ResponseEntity<List<DevicePlusDeviceModelDTO>>(deviceService.getDevicesForSite(siteId),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateDevice(@RequestBody DeviceDTO deviceDTO, @PathVariable("deviceId") Integer deviceId)
			throws Exception {
		return new ResponseEntity<DevicePlusDeviceModelDTO>(deviceService.updateDevice(deviceDTO, deviceId),
				HttpStatus.OK);
	}
